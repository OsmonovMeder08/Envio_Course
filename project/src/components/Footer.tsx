...
export default function Footer() {
  ...
  return (
    <footer className={`${theme === 'dark' ? 'bg-gray-950' : 'bg-gray-900'} text-white transition-colors`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Envio</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/courses" className="hover:text-white transition-colors">English </Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/teachers" className="hover:text-white transition-colors">..</Link></li>
              <li><Link to="/teachers" className="hover:text-white transition-colors">..</Link></li>
              <li><Link to="/teachers" className="hover:text-white transition-colors">..</Link></li>
              <li><Link to="/teachers" className="hover:text-white transition-colors">..</Link></li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <div className="flex items-center space-x-2">
                ...
                <span>+996(999) 29-12-08</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4" />
                <span>envio@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; Envio. {t('footer.rights')}</p>
        </div>
      </div>
    </footer>
  );
